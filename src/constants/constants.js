...
const projects = [
  {
    ...
    features: [
      "Chat in real-time with friends or in groups, share files easily, and enjoy a responsive, secure, and modern interface across all devices."
    ],
    tags: [
      {
        name: "NextJs",
  ...
  {
    name: "KASHI LEARNING",
    description: "Build an industrial-level e-learning platform (LMS) with Next.js 13, TypeScript, Node.js, Express, MongoDB, Redis, RTK Query, and Socket.io. Supports real-time interactions, course management, and scalable performance for modern online learning.",
    features: [
      "The platform allows users to enroll in and manage courses, track their learning progress, and interact in real-time through chat and notifications. Students can stream videos and access course materials, while secure authentication and Redis-powered performance ensure a smooth and reliable learning experience.",
    ],
    tags: [
      {
        name: "react",
